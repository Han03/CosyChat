    ...
    def __init__(self,
        ...
        try:
            ...
            try:
                ...
                cache_dir = os.path.expanduser('~/.cache/modelscope/hub/pengzhendong/wetext')
                if os.path.exists(cache_dir):
                    self.zh_tn_model = ZhNormalizer(
                        tagger_path=os.path.join(cache_dir, 'zh/tn/tagger.fst'),
                        verbalizer_path=os.path.join(cache_dir, 'zh/tn/verbalizer_remove_erhua.fst'),
                        lang='zh',
                        remove_erhua=False
                    )
                    self.en_tn_model = ZhNormalizer(
                        tagger_path=os.path.join(cache_dir, 'en/tn/tagger.fst'),
                        verbalizer_path=os.path.join(cache_dir, 'en/tn/verbalizer.fst'),
                        lang='en'
                    )
                else:
